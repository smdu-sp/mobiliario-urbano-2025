  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent>
        ...
        <p className="mb-4">Seu formulário foi enviado com sucesso. Anote o número do protocolo para referência futura.</p>
        <Button onClick={() => {
          ...
          className="font-bold"
        >
          <Copy className="mr-2 h-4 w-4" />{protocolo}
        </Button>
        <Button onClick={onClose} className="mt-4 px-4 py-2 bg-primary">
          Fechar
        </Button>
      </DialogContent>
    </Dialog>
