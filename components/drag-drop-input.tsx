...
import { useState, useRef, type DragEvent, type ChangeEvent, forwardRef, useImperativeHandle } from "react"
...
const DragDropInput = forwardRef<DragDropInputRef, DragDropInputProps>(
  (
    ...
    let inputProps: React.InputHTMLAttributes<HTMLInputElement> & { ref?: any } = {
      type: "file",
      className: "hidden",
      multiple: multiple,
      accept: accept,
      ...
      <div className={cn("w-full", className)}>
        <div
          className={cn(
            ...
            disabled && "opacity-60 cursor-not-allowed border-gray-200 hover:border-gray-200",
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">ou clique para selecionar</p>
            <Button
              type="button"
              variant="outline"
              size="sm"
        ...
        {files.length > 0 && (
          <div className="mt-4">
            <div className="flex justify-between items-center mb-2">
              <h4 className="text-xs font-medium">Arquivos selecionados ({files.length})</h4>
              {maxSize && (
              ...
              {files.map((file, index) => (
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-xs font-medium truncate max-w-[150px] sm:max-w-xs">{file.name}</p>
